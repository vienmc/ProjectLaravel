    ...
    public function run()
    {
        ...
        \Illuminate\Support\Facades\DB::table('orders')->insert([
            [
                ...
                'account_id' => 10,
                'shipping_address'=>"Quảng Ninh",
                'shipping_phone'=>"0347882743",
                'total_money'=>2220000,
                'shipping_email' => 'trongphu@gmail.com',
                'order_status' => 1,
                'shipping_status'=>1,
                'shipping_notes' =>'Ngõ 54 , ngách 43 Cẩm phả Quảng Ninh',
                ...
                'order_status' => 1,
                'shipping_status'=>2,
                'shipping_notes' =>'Hồ tùng mậu ngõ 23 ngách 23 , Hà nội',
                'created_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s'),
                'updated_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s')
            ],[
                'id' => 5,
                ...
                'order_status' => 1,
                'shipping_status'=> 3,
                'shipping_notes' =>'Kim mã , ngách 43 ngõ 23,hà nội',
                'created_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s'),
                'updated_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s')
            ],[
                'id' => 6,
                ...
                'account_id' =>  11,
                'shipping_address'=>"Thành Phố HCM",
                'shipping_phone'=>"0347885712",
                'total_money'=>5200000,
                'shipping_email' => 'sontung@gmail.com',
                'order_status' => 1,
                'shipping_status'=> 3,
                'shipping_notes' =>'Quận 8 ,Thành Phố HCM',
                'created_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s'),
                'updated_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s')
            ],[
                'id' => 7,
                ...
                'order_status' => 1,
                'shipping_status'=> 4,
                'shipping_notes' =>'Hòn gai , ngõ 23 , ngách 43 , Quảng Ninh',
                'created_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s'),
                'updated_at' => \Illuminate\Support\Carbon::now()->addDays(0)->format('Y-m-d H:i:s')
            ]
