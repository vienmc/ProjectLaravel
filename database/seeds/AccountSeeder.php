...

    {
        ...
        \Illuminate\Support\Facades\DB::table('accounts')->insert([
            [
                ...
                'salt' => 'tyutyu',
                'password' => md5('tyutyu' . self::$password),
                'name' => 'hoa',
                'phone' => '0123456789',
                'role' => 1,
                'status' => 1,
                ...
                'salt' => 'ghjghj',
                'password' => md5('ghjghj' . self::$password),
                'name' => 'admin',
                'phone' => '0123456789',
                'role' => 1,
                'status' => 1,
                ...
                'salt' => 'nhgghn',
                'password' => md5('nhgghn' . self::$password),
                'name' => 'hoa',
                'phone' => '0123456789',
                'role' => 1,
                'status' => 1,
                ...
                'salt' => 'bnhbnh',
                'password' => md5('bnhbnh' . self::$password),
                'name' => 'hoa',
                'phone' => '0123456789',
                'role' => 1,
                'status' => 1,
                ...
                'salt' => 'njknjk',
                'password' => md5('njknjk' . self::$password),
                'name' => 'hoa',
                'phone' => '0123456789',
                'role' => 1,
                'status' => 1,
