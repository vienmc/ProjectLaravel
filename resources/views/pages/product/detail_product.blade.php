    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5">
            ...
            <div id="similar-product" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        @foreach($detail_product->large_photos as $p)
                            <a href="#large-photo" id="click-img"> <img src="{{$p}}" class="img-small"
        ...
        <div class="col-sm-7">
            <div class="product-information"><!--/product-information-->
                <img src="https://res.cloudinary.com/hoadaica/image/upload/v1596458004/new_u2jwsl.jpg"
                ...
                <a href=""><img src="https://res.cloudinary.com/hoadaica/image/upload/v1596458563/share_fpdyfe.png"
            ...
            <div class="tab-pane fade" id="reviews">
                <br class="col-sm-12">
                    ...
                    @foreach($review as $key =>$rv)
                        <ul>
                            <li><a href=""><i class="fa fa-user"></i>{{$rv->username}}</a></li>
                            <li><a href=""><i class="fa fa-clock-o"></i>{{$rv->created_at}}</a></li>
                        </ul>
                        <p>{{$rv->content}}</p>
                        <br>--------------------------------------------------------------------------</br>
                    @endforeach
                        ...
                        <form action={{URL::to('/chi-tiet-san-pham/'.$detail_product->id)}} method="post">
                            @csrf
